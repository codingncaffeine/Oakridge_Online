...
export const MONSTERS: MonsterDef[] = [
  ...
  },
  {
    ...
    drops: {
      ...
      main: [{ item: "gale_charm", weight: 2 }, 
        ...
        { item: "glimstone", min: 1, max: 4, weight: 8 },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    drops: {
      ...
      main: [{ item: "thought_charm", weight: 2 }, { item: "stone_charm", weight: 2 }, 
        ...
        { item: "glimstone", min: 2, max: 6, weight: 8 },
      ],
  ...
  },
  {
    ...
    drops: {
      ...
      main: [{ item: "sinew_charm", weight: 2 }, 
        ...
        { item: "glimstone", min: 3, max: 8, weight: 8 },
      ],
  ...
  },
  {
    ...
    drops: {
      ...
      main: [
        ...
        { item: "ember_rune", min: 4, max: 10, weight: 8 },
        { item: "glimstone", min: 4, max: 10, weight: 8 },
      ],
  ...
  },
  {
    ...
    drops: {
      ...
      main: [{ item: "wild_charm", weight: 2 }, 
        ...
        { item: "glimstone", min: 5, max: 12, weight: 8 },
      ],
  ...
  },
  {
    ...
    drops: {
      ...
      main: [{ item: "bloom_charm", weight: 2 }, 
        ...
        { item: "glimstone", min: 6, max: 14, weight: 8 },
      ],
  ...
  },
  {
    ...
    drops: {
      ...
      main: [{ item: "star_charm", weight: 2 }, 
        ...
        { item: "glimstone", min: 6, max: 15, weight: 8 },
      ],
  ...
  // shape the bestiary already has, in the mountain's own colours: nothing here needed new art.
  {
    ...
    drops: {
      always: [{ item: "bones" }],
      main: [{ item: "coins", min: 20, max: 90, weight: 70 }, { item: "coal", min: 1, max: 2, weight: 40 }, { item: "ember_rune", min: 1, max: 3, weight: 18 }],
  ...
  // The Sallowfen (Wave 4): Mourn's dead, risen to a bell that rings under the water, on the skeleton's shape hung with weed.
  {
    ...
    drops: {
      always: [{ item: "bones" }],
      main: [{ item: "star_charm", weight: 2 }, { item: "coins", min: 30, max: 110, weight: 60 }, { item: "iron_helm", weight: 8 }, { item: "silver_ring", weight: 4 }, { item: "grave_rune", min: 1, max: 2, weight: 8 }, { item: "sinew_rune", min: 3, max: 8, weight: 8 }, { item: "star_rune", min: 1, max: 2, weight: 6 }, { item: "glimstone", min: 6, max: 15, weight: 8 }],
  ...
  // The Fen Hollows (Wave 4), old Mourn under the new, band 50–70: what lives in its black water, on the crawler's shape, root-pale.
  {
    ...
    drops: {
      always: [{ item: "bones" }],
      main: [{ item: "coins", min: 30, max: 120, weight: 58 }, { item: "tide_rune", min: 2, max: 6, weight: 22 }, { item: "bait", min: 5, max: 15, weight: 20 }, { item: "iron_helm", weight: 8 }, { item: "glimstone", min: 6, max: 15, weight: 8 }],
      rare: [{ item: "coldiron_dagger", weight: 5 }],
    },
  },
  {
    ...
    drops: {
      always: [{ item: "bones" }],
      main: [{ item: "coins", min: 40, max: 140, weight: 60 }, { item: "coal", min: 2, max: 4, weight: 36 }, { item: "emberite_ore", weight: 14 }, { item: "steel_dagger", weight: 8 }, { item: "glimstone", min: 6, max: 15, weight: 8 }],
  ...
  // The Sallowfen's far side (Wave 4), on the person's shape in the fen's colours.
  {
    ...
    drops: {
      always: [{ item: "bones" }],
      main: [
        { item: "coins", min: 60, max: 200, weight: 50 }, { item: "tide_rune", min: 3, max: 9, weight: 22 }, { item: "ember_rune", min: 4, max: 10, weight: 14 },
        { item: "steel_helm", weight: 6 },
        { item: "bloom_rune", min: 1, max: 3, weight: 8 },
        { item: "glimstone", min: 8, max: 18, weight: 8 },
      ],
  ...
  // Deepdelve Mine's gold vault (PLAN §8.5, Wave 3), on the skeleton's shape, in gold.
  {
    ...
    drops: {
      ...
      main: [{ item: "oath_charm", weight: 2 }, 
        ...
        { item: "glimstone", min: 8, max: 18, weight: 4 },
      ],
  ...
  },
  {
    ...
    drops: {
      ...
      main: [
        ...
        { item: "heart_rune", weight: 4 },
        { item: "glimstone", min: 10, max: 24, weight: 4 },
      ],
  ...
  // The bottom of the Fen Hollows: old Mourn's bellringer over the bell, on the skeleton's shape gone green.
  {
    ...
    drops: {
      ...
      main: [{ item: "shade_charm", weight: 2 }, 
        ...
        { item: "glimstone", min: 10, max: 24, weight: 8 },
      ],
  ...
  },
  {
    ...
    drops: {
      ...
      main: [{ item: "fury_charm", weight: 2 }, 
        ...
        { item: "glimstone", min: 12, max: 28, weight: 8 },
      ],
...
export const VILLAGERS: MonsterDef[] = [
  ...
  villager("rune_seller", "Hettie Rook", "She has sold runes to three generations of the village, and remembers what each of them blew up.", [1, 6, 0, 1, 1, 0, 2, 0, 1, 9, 5, 5, 3], {
    talk: "rune_seller", shop: "oakridge_runes", wander: 0, apron: 0x3a2f4a,
  }),
  ...
  villager("tide_seller", "Delphine Merrow", "Her staves hang from the rafters like a catch drying.", [1, 3, 0, 0, 1, 0, 2, 1, 2, 11, 9, 12, 6], {
    talk: "tide_seller", shop: "wickstead_staves", wander: 0, apron: 0x2e5a6e,
  }),
  ...
  villager("ember_seller", "Garrick Brenner", "His eyebrows have grown back at least once.", [0, 4, 1, 2, 2, 1, 0, 1, 3, 3, 10, 6, 5], {
    talk: "ember_seller", shop: "kilnhold_staves", wander: 0, apron: 0x5a2a1e,
  }),
