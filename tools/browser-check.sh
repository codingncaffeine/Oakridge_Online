...
#        PREVIEW=<resources|village|stonecote|thornbury|wickstead|brinehaven|npcmaker|streampreview> SHOTS_DIR=<dir> tools/browser-check.sh   # likewise for the other previews
set -uo pipefail
P="$(cd "$(dirname "$0")/.." && pwd)"
. "$P/tools/env.sh"
